...
class ChildrenShoesProvider with ChangeNotifier {

  List<ProductModel> childrenShoesDataList = [];
  void getChildrenShoesData() async {
    List<ProductModel> newList = [];

    QuerySnapshot reviewChildrenShoesValue =
    await FirebaseFirestore.instance.collection("ChildrenShoes").get();
    reviewChildrenShoesValue.docs.forEach((element) {
    ...
    childrenShoesDataList = newList;
    notifyListeners();
  }

  List<ProductModel> get getChildrenShoesDataList {
    return childrenShoesDataList;
  }

  ////////////// BagAddFunction ////////////
  void addChildrenShoesData({
    String? productId,
