...
class BabyClothesProvider with ChangeNotifier {

  List<ProductModel> babyClothesDataList = [];
  void getBabyClothesData() async {
    List<ProductModel> newList = [];

    QuerySnapshot reviewBabyClothesValue =
    await FirebaseFirestore.instance.collection("babyClothes").get();
    reviewBabyClothesValue.docs.forEach((element) {
    ...
    babyClothesDataList = newList;
    notifyListeners();
  }

  List<ProductModel> get getBabyClothesDataList {
    return babyClothesDataList;
  }

  ////////////// SweatshirtAddFunction ////////////
  void addBabyClothesData({
    String? productId,
