...
class BackpackProvider with ChangeNotifier {
  ...
  List<ProductModel> backpackDataList = [];
  void getBackpackData() async {
    List<ProductModel> newList = [];

    QuerySnapshot reviewBackpackValue =
    await FirebaseFirestore.instance.collection("WomenBackpack").get();
    reviewBackpackValue.docs.forEach((element) {
    ...
    backpackDataList = newList;
    notifyListeners();
  }

  List<ProductModel> get getBackpackDataList {
