...
class HandBagProvider with ChangeNotifier {

  List<ProductModel> handBagDataList = [];
  void getHandBagData() async {
    List<ProductModel> newList = [];

    QuerySnapshot reviewHandBagValue =
    await FirebaseFirestore.instance.collection("WomenHandBage").get();
    reviewHandBagValue.docs.forEach((element) {
    ...
    handBagDataList = newList;
    notifyListeners();
  }

  List<ProductModel> get getHandBagDataList {
    return handBagDataList;
  }
