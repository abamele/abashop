...
class ShoulderBagProvider with ChangeNotifier {

  List<ProductModel> shoulderBagDataList = [];
  void getShoulderBagData() async {
    List<ProductModel> newList = [];

    QuerySnapshot reviewShoulderBagValue =
    await FirebaseFirestore.instance.collection("WomenShoulderBag").get();
    reviewShoulderBagValue.docs.forEach((element) {
    ...
    shoulderBagDataList = newList;
    notifyListeners();
  }

  List<ProductModel> get getShoulderBagDataList {
    return shoulderBagDataList;
  }

  ////////////// BagAddFunction ////////////
  void addShoulderBagData({
    String? productId,
