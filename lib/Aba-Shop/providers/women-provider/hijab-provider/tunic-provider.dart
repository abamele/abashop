...
class TunicProvider with ChangeNotifier {

  List<ProductModel> tunicDataList = [];
  void getTunicData() async {
    List<ProductModel> newList = [];

    QuerySnapshot reviewTunicValue =
    await FirebaseFirestore.instance.collection("Tunic").get();
    reviewTunicValue.docs.forEach((element) {
    ...
    tunicDataList = newList;
    notifyListeners();
  }

  List<ProductModel> get getTunicDataList {
    return tunicDataList;
  }

  ////////////// BagAddFunction ////////////
  void addHijabTunicData({
    String? productId,
