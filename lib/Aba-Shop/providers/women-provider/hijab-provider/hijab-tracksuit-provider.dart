...
class HijabTracksuitProvider with ChangeNotifier {

  List<ProductModel> hijabTracksuitDataList = [];
  void getHijabTracksuitData() async {
    List<ProductModel> newList = [];

    QuerySnapshot reviewHijabTracksuitValue =
    await FirebaseFirestore.instance.collection("HijabTracksuit").get();
    reviewHijabTracksuitValue.docs.forEach((element) {
    ...
    hijabTracksuitDataList = newList;
    notifyListeners();
  }

  List<ProductModel> get getHijabTracksuitDataList {
    return hijabTracksuitDataList;
  }

  ////////////// BagAddFunction ////////////
  void addHijabTracksuitData({
    String? productId,
