...
class SkirtProvider with ChangeNotifier {

  List<ProductModel> skirtDataList = [];
  void getSkirtData() async {
    List<ProductModel> newList = [];

    QuerySnapshot reviewSkirtValue =
    await FirebaseFirestore.instance.collection("WomenSkirts").get();
    reviewSkirtValue.docs.forEach((element) {
    ...
    skirtDataList = newList;
    notifyListeners();
  }

  List<ProductModel> get getSkirtDataList {
    return skirtDataList;
  }
