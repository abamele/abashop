...
class WaistcoatProvider with ChangeNotifier {

  List<ProductModel> waistcoatDataList = [];
  void getWaistcoatData() async {
    List<ProductModel> newList = [];

    QuerySnapshot reviewWaistcoatValue =
    await FirebaseFirestore.instance.collection("WomenWaistcoat").get();
    reviewWaistcoatValue.docs.forEach((element) {
    ...
    waistcoatDataList = newList;
    notifyListeners();
  }

  List<ProductModel> get getWaistDataList {
    return waistcoatDataList;
  }

  ////////////// BagAddFunction ////////////
  void addWaistcoatData({
    String? productId,
