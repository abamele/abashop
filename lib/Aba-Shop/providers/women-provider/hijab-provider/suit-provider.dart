...
class SuitProvider with ChangeNotifier {

  List<ProductModel> suitDataList = [];
  void getSuitData() async {
    List<ProductModel> newList = [];

    QuerySnapshot reviewSuitValue =
    await FirebaseFirestore.instance.collection("Suits").get();
    reviewSuitValue.docs.forEach((element) {
    ...
    suitDataList = newList;
    notifyListeners();
  }

  List<ProductModel> get getSuitDataList {
    return suitDataList;
  }
