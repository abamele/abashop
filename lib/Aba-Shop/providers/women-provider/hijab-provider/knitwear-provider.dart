...
class KnitwearProvider with ChangeNotifier {

  List<ProductModel> knitwearDataList = [];
  void getKnitwearData() async {
    List<ProductModel> newList = [];

    QuerySnapshot reviewDressValue =
    await FirebaseFirestore.instance.collection("WomenKnitwear").get();
    ...
    knitwearDataList = newList;
    notifyListeners();
  }

  List<ProductModel> get getKnitwearDataList {
    return knitwearDataList;
  }

  ////////////// BagAddFunction ////////////
  void addKnitwearData({
    String? productId,
