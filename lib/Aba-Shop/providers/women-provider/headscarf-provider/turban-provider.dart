...
class TurbanProvider with ChangeNotifier {

  List<ProductModel> turbanDataList = [];
  void getTurbanData() async {
    List<ProductModel> newList = [];

    QuerySnapshot reviewTurbanValue =
    await FirebaseFirestore.instance.collection("WomenTurban").get();
    reviewTurbanValue.docs.forEach((element) {
    ...
    turbanDataList = newList;
    notifyListeners();
  }

  List<ProductModel> get getTurbanDataList {
    return turbanDataList;
  }
