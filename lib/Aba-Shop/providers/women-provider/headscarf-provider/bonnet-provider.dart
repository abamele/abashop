...
class BonnetProvider with ChangeNotifier {

  List<ProductModel> bonnetDataList = [];
  void getBonnetData() async {
    List<ProductModel> newList = [];

    QuerySnapshot reviewBonnetValue =
    await FirebaseFirestore.instance.collection("WomenBonnet").get();
    reviewBonnetValue.docs.forEach((element) {
    ...
    bonnetDataList = newList;
    notifyListeners();
  }

  List<ProductModel> get getBonnetDataList {
    return bonnetDataList;
  }
