...
class ScarfProvider with ChangeNotifier {

  List<ProductModel> scarfDataList = [];
  void getScarfData() async {
    List<ProductModel> newList = [];

    QuerySnapshot reviewScarfValue =
    await FirebaseFirestore.instance.collection("WomenScarf").get();
    reviewScarfValue.docs.forEach((element) {
    ...
    scarfDataList = newList;
    notifyListeners();
  }

  List<ProductModel> get getScarfDataList {
    return scarfDataList;
  }
