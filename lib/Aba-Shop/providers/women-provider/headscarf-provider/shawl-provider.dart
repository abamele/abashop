...
class ShawlProvider with ChangeNotifier {

  List<ProductModel> shawlDataList = [];
  void getShawlData() async {
    List<ProductModel> newList = [];

    QuerySnapshot reviewShawlValue =
    await FirebaseFirestore.instance.collection("Shawl").get();
    reviewShawlValue.docs.forEach((element) {
    ...
    shawlDataList = newList;
    notifyListeners();
  }

  List<ProductModel> get getShawlDataList {
    return shawlDataList;
  }
