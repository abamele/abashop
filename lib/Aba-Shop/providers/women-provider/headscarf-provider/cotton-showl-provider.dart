...
class CottonShawlProvider with ChangeNotifier {

  List<ProductModel> cottonShawlDataList = [];
  void getCottonShawlData() async {
    List<ProductModel> newList = [];

    QuerySnapshot reviewCottonShwalValue =
    await FirebaseFirestore.instance.collection("WomenCottonShawl").get();
    reviewCottonShwalValue.docs.forEach((element) {
    ...
    cottonShawlDataList = newList;
    notifyListeners();
  }

  List<ProductModel> get getCottonShawlDataList {
    return cottonShawlDataList;
  }

  ////////////// PantAddFunction ////////////
  void addCottonShwalData({
    String? productId,
