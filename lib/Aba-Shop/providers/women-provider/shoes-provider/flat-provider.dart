...
class BallerinasProvider with ChangeNotifier {

  List<ProductModel> ballerinasDataList = [];
  void getBallerinasData() async {
    List<ProductModel> newList = [];

    QuerySnapshot reviewBallerinasValue =
    await FirebaseFirestore.instance.collection("WomenFlats").get();
    reviewBallerinasValue.docs.forEach((element) {
    ...
    ballerinasDataList = newList;
    notifyListeners();
  }

  List<ProductModel> get getBallerinasDataList {
    return ballerinasDataList;
  }

  ////////////// ShoesAddFunction ////////////
  void addBallerinasData({
    String? productId,
