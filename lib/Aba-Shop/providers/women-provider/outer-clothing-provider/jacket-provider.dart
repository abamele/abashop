...
class JacketProvider with ChangeNotifier {

  List<ProductModel> jacketDataList = [];
  void getJacketData() async {
    List<ProductModel> newList = [];

    QuerySnapshot reviewJacketValue =
    await FirebaseFirestore.instance.collection("WomenJacket").get();
    reviewJacketValue.docs.forEach((element) {
    ...
    jacketDataList = newList;
    notifyListeners();
  }

  List<ProductModel> get getJacketDataList {
    return jacketDataList;
  }
