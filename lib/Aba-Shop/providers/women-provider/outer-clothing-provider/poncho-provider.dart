...
class PonchoProvider with ChangeNotifier {

  List<ProductModel> ponchoDataList = [];
  void getPonchoData() async {
    List<ProductModel> newList = [];

    QuerySnapshot reviewPonchoValue =
    await FirebaseFirestore.instance.collection("WomenPoncho").get();
    reviewPonchoValue.docs.forEach((element) {
    ...
    ponchoDataList = newList;
    notifyListeners();
  }

  List<ProductModel> get getPonchoDataList {
    return ponchoDataList;
  }
