...
class CoatProvider with ChangeNotifier {

  List<ProductModel> coatDataList = [];
  void getCoatData() async {
    List<ProductModel> newList = [];

    QuerySnapshot reviewCoatValue =
    await FirebaseFirestore.instance.collection("WomenCoat").get();
    reviewCoatValue.docs.forEach((element) {
    ...
    coatDataList = newList;
    notifyListeners();
  }

  List<ProductModel> get getCoatDataList {
    return coatDataList;
  }
