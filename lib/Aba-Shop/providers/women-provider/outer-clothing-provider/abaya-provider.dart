...
class AbayaProvider with ChangeNotifier {

  List<ProductModel> abayaDataList = [];
  void getAbayaData() async {
    List<ProductModel> newList = [];

    QuerySnapshot reviewAbayaValue =
    await FirebaseFirestore.instance.collection("WomenAbaya").get();
    reviewAbayaValue.docs.forEach((element) {
    ...
    abayaDataList = newList;
    notifyListeners();
  }

  List<ProductModel> get getAbayaDataList {
    return abayaDataList;
  }
