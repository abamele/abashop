...
class MenShoesProvider with ChangeNotifier {

  List<ProductModel> menShoesDataList = [];
  void getShoesData() async {
    List<ProductModel> newList = [];

    QuerySnapshot reviewMenSHoesValue =
    await FirebaseFirestore.instance.collection("MenShoes").get();
    reviewMenSHoesValue.docs.forEach((element) {
    ...
    menShoesDataList = newList;
    notifyListeners();
  }

  List<ProductModel> get getMenShoesDataList {
    return menShoesDataList;
  }

  ////////////// ShoesAddFunction ////////////
  void addMenShoesData({
    String? productId,
