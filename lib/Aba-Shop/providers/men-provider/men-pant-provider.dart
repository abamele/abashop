...
class MenPantsProvider with ChangeNotifier {

  List<ProductModel> menPantDataList = [];
  void getMenPantsData() async {
    List<ProductModel> newList = [];

    QuerySnapshot reviewMenPantValue =
    await FirebaseFirestore.instance.collection("MenPants").get();
    reviewMenPantValue.docs.forEach((element) {
    ...
    menPantDataList = newList;
    notifyListeners();
  }

  List<ProductModel> get getMenPantsDataList {
    return menPantDataList;
  }

  ////////////// PantAddFunction ////////////
  void addMenPantsData({
    String? productId,
