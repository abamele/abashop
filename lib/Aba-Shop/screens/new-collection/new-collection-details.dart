...
class NewCollectionDetails extends StatefulWidget {
  NewCollectionDetails({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<NewCollectionDetails> createState() => _NewCollectionDetailsState();
}

class _NewCollectionDetailsState extends State<NewCollectionDetails> {
