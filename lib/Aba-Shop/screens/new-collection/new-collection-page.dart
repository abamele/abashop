...
import 'package:abashop/Aba-Shop/screens/new-collection/single-new-collection.dart';
...
class _NewCollectionPageState extends State<NewCollectionPage> {
  ...
  Widget build(BuildContext context) {
    CollectionProvider collectionProvider = Provider.of(context);
    collectionProvider.getCollectionData();
    ...
    return Scaffold(
      ...
      drawer: NavberWidget(),
      body: collectionProvider.collectionDataList.isEmpty
          ? Center(
        child: Text("No Data"),
      )
          : GridView.builder(
          gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
              ...
              crossAxisSpacing: 5,
              mainAxisSpacing: 5),
          itemCount: collectionProvider.getCollectionDataList.length,
          itemBuilder: (context, index) {
            final data = collectionProvider.getCollectionDataList[index];
            return SingleNewCollection(productModel: data);
          }),
    );
  }
}
