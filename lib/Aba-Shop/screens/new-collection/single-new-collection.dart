...
import 'package:abashop/Aba-Shop/screens/new-collection/new-collection-details.dart';
...
class SingleNewCollection extends StatefulWidget {
  SingleNewCollection({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<SingleNewCollection> createState() => _SingleNewCollectionState();
}

class _SingleNewCollectionState extends State<SingleNewCollection> {
    ...
    return GestureDetector(
      ...
      onTap: () async {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => NewCollectionDetails(
