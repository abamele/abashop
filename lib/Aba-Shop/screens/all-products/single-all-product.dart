...
import 'package:abashop/Aba-Shop/screens/all-products/all-product-details.dart';
...
class SingleAllProduct extends StatefulWidget {
  SingleAllProduct({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<SingleAllProduct> createState() => _SingleAllProductState();
}

class _SingleAllProductState extends State<SingleAllProduct> {
