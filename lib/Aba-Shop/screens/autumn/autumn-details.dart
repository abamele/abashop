...
class AutumnDetails extends StatefulWidget {
  AutumnDetails({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<AutumnDetails> createState() => _AutumnDetailsState();
}

class _AutumnDetailsState extends State<AutumnDetails> {
