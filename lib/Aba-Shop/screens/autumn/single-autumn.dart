...
class SingleAutumn extends StatefulWidget {
  SingleAutumn({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<SingleAutumn> createState() => _SingleAutumnState();
}

class _SingleAutumnState extends State<SingleAutumn> {
