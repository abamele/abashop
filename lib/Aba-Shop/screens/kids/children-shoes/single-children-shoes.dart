...
import 'package:abashop/Aba-Shop/screens/kids/children-clothes/children-clothes-details.dart';
...
import 'children-shoes-details.dart';


class SingleChildrenShoes extends StatefulWidget {
  SingleChildrenShoes({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<SingleChildrenShoes> createState() => _SingleChildrenShoesState();
}

class _SingleChildrenShoesState extends State<SingleChildrenShoes> {
    ...
    return GestureDetector(
      ...
      onTap: () async {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => ChildrenShoesDetails(
