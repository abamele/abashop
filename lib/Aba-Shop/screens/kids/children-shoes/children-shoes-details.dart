...
class ChildrenShoesDetails extends StatefulWidget {
  ChildrenShoesDetails({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<ChildrenShoesDetails> createState() => _ChildrenShoesDetailsState();
}

class _ChildrenShoesDetailsState extends State<ChildrenShoesDetails> {
