...
class SingleChildrenClothes extends StatefulWidget {
  SingleChildrenClothes({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<SingleChildrenClothes> createState() => _SingleChildrenClothesState();
}

class _SingleChildrenClothesState extends State<SingleChildrenClothes> {
    ...
    return GestureDetector(
      ...
      onTap: () async {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => ChildrenClothesDetails(
