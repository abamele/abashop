...
class ChildrenClothesPage extends StatefulWidget {
  const ChildrenClothesPage({super.key});

  @override
  State<ChildrenClothesPage> createState() => _ChildrenClothesPageState();
}

class _ChildrenClothesPageState extends State<ChildrenClothesPage> {
  @override
  Widget build(BuildContext context) {
    ChildrenClothesProvider childrenClothesProvider = Provider.of(context);
    childrenClothesProvider.getChildrenClothesData();
    ...
    return Scaffold(
      ...
      drawer: NavberWidget(),
      body: childrenClothesProvider.childrenClothesDataList.isEmpty
          ? Center(
        child: Text("No Data"),
      )
          : GridView.builder(
          gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
              ...
              crossAxisSpacing: 5,
              mainAxisSpacing: 5),
          itemCount: childrenClothesProvider.getChildrenClothesDataList.length,
          itemBuilder: (context, index) {
            final data = childrenClothesProvider.getChildrenClothesDataList[index];
