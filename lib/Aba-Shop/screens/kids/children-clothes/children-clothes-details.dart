...
class ChildrenClothesDetails extends StatefulWidget {
  ChildrenClothesDetails({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<ChildrenClothesDetails> createState() => _ChildrenClothesDetailsState();
}

class _ChildrenClothesDetailsState extends State<ChildrenClothesDetails> {
