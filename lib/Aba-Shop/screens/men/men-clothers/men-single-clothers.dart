...
import 'package:abashop/Aba-Shop/screens/men/men-clothers/men-clothers-details.dart';
...
class SingleMenClothers extends StatefulWidget {
  SingleMenClothers({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<SingleMenClothers> createState() => _SingleMenClothersState();
}

class _SingleMenClothersState extends State<SingleMenClothers> {
    ...
    return GestureDetector(
      ...
      onTap: () async {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => MenClothersDetails(
