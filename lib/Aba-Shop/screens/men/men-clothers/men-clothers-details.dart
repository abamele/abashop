...
class MenClothersDetails extends StatefulWidget {
  MenClothersDetails({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<MenClothersDetails> createState() => _MenClothersDetailsState();
}

class _MenClothersDetailsState extends State<MenClothersDetails> {
