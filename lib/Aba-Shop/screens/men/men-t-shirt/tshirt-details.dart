...
class MenTShirtDetails extends StatefulWidget {
  MenTShirtDetails({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<MenTShirtDetails> createState() => _MenTShirtDetailsState();
}

class _MenTShirtDetailsState extends State<MenTShirtDetails> {
