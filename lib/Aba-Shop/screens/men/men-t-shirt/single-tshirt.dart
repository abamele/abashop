...
import 'package:abashop/Aba-Shop/screens/men/men-t-shirt/tshirt-details.dart';
...
class SingleMenTShirt extends StatefulWidget {
  SingleMenTShirt({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<SingleMenTShirt> createState() => _SingleMenTShirtState();
}

class _SingleMenTShirtState extends State<SingleMenTShirt> {
    ...
    return GestureDetector(
      ...
      onTap: () async {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => MenTShirtDetails(
