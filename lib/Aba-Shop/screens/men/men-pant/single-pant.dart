...
import 'package:abashop/Aba-Shop/screens/men/men-pant/pant-details.dart';
...
class SingleMenPant extends StatefulWidget {
  SingleMenPant({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<SingleMenPant> createState() => _SingleMenPantState();
}

class _SingleMenPantState extends State<SingleMenPant> {
    ...
    return GestureDetector(
      ...
      onTap: () async {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => MenPantDetails(
