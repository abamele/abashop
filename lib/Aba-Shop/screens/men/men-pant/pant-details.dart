...
class MenPantDetails extends StatefulWidget {
  MenPantDetails({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<MenPantDetails> createState() => _MenPantDetailsState();
}

class _MenPantDetailsState extends State<MenPantDetails> {
