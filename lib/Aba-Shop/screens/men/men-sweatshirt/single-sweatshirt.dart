...
import 'package:abashop/Aba-Shop/screens/autumn/autumn-details.dart';
import 'package:abashop/Aba-Shop/screens/men/men-sweatshirt/sweatshirt-details.dart';
...
class SingleMenSweatshirt extends StatefulWidget {
  SingleMenSweatshirt({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<SingleMenSweatshirt> createState() => _SingleMenSweatshirtState();
}

class _SingleMenSweatshirtState extends State<SingleMenSweatshirt> {
    ...
    return GestureDetector(
      ...
      onTap: () async {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => MenSweatshirtDetails(
