...
class MenSweatshirtDetails extends StatefulWidget {
  MenSweatshirtDetails({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<MenSweatshirtDetails> createState() => _MenSweatshirtDetailsState();
}

class _MenSweatshirtDetailsState extends State<MenSweatshirtDetails> {
