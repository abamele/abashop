...
class MenBagDetails extends StatefulWidget {
  MenBagDetails({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<MenBagDetails> createState() => _MenBagDetailsState();
}

class _MenBagDetailsState extends State<MenBagDetails> {
