...
class MenShoesDetails extends StatefulWidget {
  MenShoesDetails({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<MenShoesDetails> createState() => _MenShoesDetailsState();
}

class _MenShoesDetailsState extends State<MenShoesDetails> {
