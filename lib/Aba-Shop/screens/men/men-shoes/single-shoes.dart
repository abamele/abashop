...
import 'package:abashop/Aba-Shop/screens/men/men-shoes/shoes-details.dart';
...
class SingleMenShoes extends StatefulWidget {
  SingleMenShoes({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<SingleMenShoes> createState() => _SingleMenShoesState();
}

class _SingleMenShoesState extends State<SingleMenShoes> {
    ...
    return GestureDetector(
      ...
      onTap: () async {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => MenShoesDetails(
