...
import 'package:abashop/Aba-Shop/screens/women/headscarf/medine-silk-shawl/medine-silk-shawl-details.dart';
...
class SingleMedineSilkShawl extends StatefulWidget {
  SingleMedineSilkShawl({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<SingleMedineSilkShawl> createState() => _SingleMedineSilkShawlState();
}

class _SingleMedineSilkShawlState extends State<SingleMedineSilkShawl> {
    ...
    return GestureDetector(
      ...
      onTap: () async {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => MedineSilkShawlDetails(
