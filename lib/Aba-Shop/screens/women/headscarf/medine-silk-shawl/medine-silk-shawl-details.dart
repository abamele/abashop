...
class MedineSilkShawlDetails extends StatefulWidget {
  MedineSilkShawlDetails({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<MedineSilkShawlDetails> createState() => _MedineSilkShawlDetailsState();
}

class _MedineSilkShawlDetailsState extends State<MedineSilkShawlDetails> {
