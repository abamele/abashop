...
class ShawlDetails extends StatefulWidget {
  ShawlDetails({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<ShawlDetails> createState() => _ShawlDetailsState();
}

class _ShawlDetailsState extends State<ShawlDetails> {
