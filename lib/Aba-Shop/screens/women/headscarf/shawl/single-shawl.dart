...
class SingleShawl extends StatefulWidget {
  SingleShawl({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<SingleShawl> createState() => _SingleShawlState();
}

class _SingleShawlState extends State<SingleShawl> {
