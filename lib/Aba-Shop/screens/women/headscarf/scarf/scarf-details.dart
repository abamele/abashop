...
class ScarfDetails extends StatefulWidget {
  ScarfDetails({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<ScarfDetails> createState() => _ScarfDetailsState();
}

class _ScarfDetailsState extends State<ScarfDetails> {
