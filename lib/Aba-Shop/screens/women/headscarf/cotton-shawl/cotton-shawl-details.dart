...
class CottonShawlDetails extends StatefulWidget {
  CottonShawlDetails({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<CottonShawlDetails> createState() => _CottonShawlDetailsState();
}

class _CottonShawlDetailsState extends State<CottonShawlDetails> {
