...
import 'cotton-shawl-details.dart';

class SingleCottonShawl extends StatefulWidget {
  SingleCottonShawl({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<SingleCottonShawl> createState() => _SingleCottonShawlState();
}

class _SingleCottonShawlState extends State<SingleCottonShawl> {
    ...
    return GestureDetector(
      ...
      onTap: () async {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => CottonShawlDetails(
