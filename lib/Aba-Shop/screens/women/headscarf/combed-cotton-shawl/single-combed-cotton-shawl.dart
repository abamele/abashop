...
import 'package:abashop/Aba-Shop/screens/women/headscarf/combed-cotton-shawl/combed-cotton-shawl-details.dart';
import 'package:abashop/Aba-Shop/screens/women/headscarf/shawl/shawl-details.dart';
...
class SingleCombedCottonShawl extends StatefulWidget {
  SingleCombedCottonShawl({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<SingleCombedCottonShawl> createState() => _SingleCombedCottonShawlState();
}

class _SingleCombedCottonShawlState extends State<SingleCombedCottonShawl> {
    ...
    return GestureDetector(
      ...
      onTap: () async {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => CombedCottonShawlDetails(
