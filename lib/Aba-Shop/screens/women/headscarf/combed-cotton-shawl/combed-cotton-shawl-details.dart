...
class CombedCottonShawlDetails extends StatefulWidget {
  CombedCottonShawlDetails({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<CombedCottonShawlDetails> createState() => _CombedCottonShawlDetailsState();
}

class _CombedCottonShawlDetailsState extends State<CombedCottonShawlDetails> {
