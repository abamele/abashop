...
class TurbanDetails extends StatefulWidget {
  TurbanDetails({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<TurbanDetails> createState() => _TurbanDetailsState();
}

class _TurbanDetailsState extends State<TurbanDetails> {
