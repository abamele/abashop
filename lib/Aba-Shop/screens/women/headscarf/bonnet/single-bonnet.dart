...
import 'bonnet-details.dart';

class SingleBonnet extends StatefulWidget {
  SingleBonnet({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<SingleBonnet> createState() => _SingleBonnetState();
}

class _SingleBonnetState extends State<SingleBonnet> {
