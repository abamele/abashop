...
class BonnetDetails extends StatefulWidget {
  BonnetDetails({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<BonnetDetails> createState() => _BonnetDetailsState();
}

class _BonnetDetailsState extends State<BonnetDetails> {
