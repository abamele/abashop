...
class AbayaDetails extends StatefulWidget {
  AbayaDetails({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<AbayaDetails> createState() => _AbayaDetailsState();
}

class _AbayaDetailsState extends State<AbayaDetails> {
