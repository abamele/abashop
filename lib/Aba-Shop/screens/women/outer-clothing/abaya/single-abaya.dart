...
import 'abaya-details.dart';


class SingleAbaya extends StatefulWidget {
  SingleAbaya({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<SingleAbaya> createState() => _SingleAbayaState();
}

class _SingleAbayaState extends State<SingleAbaya> {
