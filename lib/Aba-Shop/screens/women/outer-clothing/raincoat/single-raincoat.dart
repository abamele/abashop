...
import 'package:abashop/Aba-Shop/screens/women/outer-clothing/raincoat/raincoat-details.dart';
...
class SingleRaincoat extends StatefulWidget {
  SingleRaincoat({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<SingleRaincoat> createState() => _SingleRaincoatState();
}

class _SingleRaincoatState extends State<SingleRaincoat> {
    ...
    return GestureDetector(
      ...
      onTap: () async {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => RaincoatDetails(
