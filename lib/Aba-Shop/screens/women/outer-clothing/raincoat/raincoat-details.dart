...
class RaincoatDetails extends StatefulWidget {
  RaincoatDetails({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<RaincoatDetails> createState() => _RaincoatDetailsState();
}

class _RaincoatDetailsState extends State<RaincoatDetails> {
