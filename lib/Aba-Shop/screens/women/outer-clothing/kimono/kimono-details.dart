...
class KimonoDetails extends StatefulWidget {
  KimonoDetails({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<KimonoDetails> createState() => _KimonoDetailsState();
}

class _KimonoDetailsState extends State<KimonoDetails> {
