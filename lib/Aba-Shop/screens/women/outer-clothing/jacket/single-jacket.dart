...
import 'jacket-details.dart';


class SingleJacket extends StatefulWidget {
  SingleJacket({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<SingleJacket> createState() => _SingleJacketState();
}

class _SingleJacketState extends State<SingleJacket> {
