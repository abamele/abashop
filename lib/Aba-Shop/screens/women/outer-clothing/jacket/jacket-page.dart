...
import '../../../../providers/women-provider/outer-clothing-provider/jacket-provider.dart';
...
class _JacketPageState extends State<JacketPage> {
  ...
  Widget build(BuildContext context) {
    JacketProvider jacketProvider = Provider.of(context);
    jacketProvider.getJacketData();
    ...
    return Scaffold(
      ...
      drawer: NavberWidget(),
      body: jacketProvider.jacketDataList.isEmpty
          ? Center(
        child: Text("No Data"),
      )
          : GridView.builder(
          gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
              ...
              crossAxisSpacing: 5,
              mainAxisSpacing: 5),
          itemCount: jacketProvider.getJacketDataList.length,
          itemBuilder: (context, index) {
            final data = jacketProvider.getJacketDataList[index];
