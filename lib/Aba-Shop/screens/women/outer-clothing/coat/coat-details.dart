...
class CoatDetails extends StatefulWidget {
  CoatDetails({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<CoatDetails> createState() => _CoatDetailsState();
}

class _CoatDetailsState extends State<CoatDetails> {
