...
import 'coat-details.dart';


class SingleCoat extends StatefulWidget {
  SingleCoat({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<SingleCoat> createState() => _SingleCoatState();
}

class _SingleCoatState extends State<SingleCoat> {
