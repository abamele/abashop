...
class PonchoDetails extends StatefulWidget {
  PonchoDetails({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<PonchoDetails> createState() => _PonchoDetailsState();
}

class _PonchoDetailsState extends State<PonchoDetails> {
