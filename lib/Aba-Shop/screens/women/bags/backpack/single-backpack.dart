...
import 'backpack-details.dart';


class SingleBackpack extends StatefulWidget {
  SingleBackpack({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<SingleBackpack> createState() => _SingleBackpackState();
}

class _SingleBackpackState extends State<SingleBackpack> {
    ...
    return GestureDetector(
      ...
      onTap: () async {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => BackpackDetails(
