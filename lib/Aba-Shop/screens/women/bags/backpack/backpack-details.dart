...
class BackpackDetails extends StatefulWidget {
  BackpackDetails({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<BackpackDetails> createState() => _BackpackDetailsState();
}

class _BackpackDetailsState extends State<BackpackDetails> {
