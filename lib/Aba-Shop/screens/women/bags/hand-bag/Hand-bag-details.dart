...
class HandBagDetails extends StatefulWidget {
  HandBagDetails({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<HandBagDetails> createState() => _HandBagDetailsState();
}

class _HandBagDetailsState extends State<HandBagDetails> {
