...
class ShoulderBagDetails extends StatefulWidget {
  ShoulderBagDetails({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<ShoulderBagDetails> createState() => _ShoulderBagDetailsState();
}

class _ShoulderBagDetailsState extends State<ShoulderBagDetails> {
