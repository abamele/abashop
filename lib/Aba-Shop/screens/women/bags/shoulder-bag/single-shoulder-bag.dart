...
import 'package:abashop/Aba-Shop/screens/women/bags/shoulder-bag/shoulder-bag-details.dart';
...
class SingleShoulderBag extends StatefulWidget {
  SingleShoulderBag({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<SingleShoulderBag> createState() => _SingleShoulderBagState();
}

class _SingleShoulderBagState extends State<SingleShoulderBag> {
    ...
    return GestureDetector(
      ...
      onTap: () async {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => ShoulderBagDetails(
