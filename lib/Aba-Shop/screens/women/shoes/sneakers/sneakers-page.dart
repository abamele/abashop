...
class _SneakersPageState extends State<SneakersPage> {
  ...
  Widget build(BuildContext context) {
    SneakersProvider sneakersProvider = Provider.of(context);
    sneakersProvider.getSneakersData();
    ...
    return Scaffold(
      ...
      drawer: NavberWidget(),
      body: sneakersProvider.sneakersDataList.isEmpty
          ? Center(
        child: Text("No Data"),
      )
          : GridView.builder(
          gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
              ...
              crossAxisSpacing: 5,
              mainAxisSpacing: 5),
          itemCount: sneakersProvider.getSneakersDataList.length,
          itemBuilder: (context, index) {
            final data = sneakersProvider.getSneakersDataList[index];
            return SingleSneakers(productModel: data);
          }),
    );
  }
}
