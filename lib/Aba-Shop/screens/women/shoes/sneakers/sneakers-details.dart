...
class SneakersDetails extends StatefulWidget {
  SneakersDetails({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<SneakersDetails> createState() => _SneakersDetailsState();
}

class _SneakersDetailsState extends State<SneakersDetails> {
