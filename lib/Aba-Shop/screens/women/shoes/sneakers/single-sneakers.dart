...
class SingleSneakers extends StatefulWidget {
  SingleSneakers({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<SingleSneakers> createState() => _SingleSneakersState();
}

class _SingleSneakersState extends State<SingleSneakers> {
    ...
    return GestureDetector(
      ...
      onTap: () async {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => SneakersDetails(
