...
import 'package:abashop/Aba-Shop/screens/women/shoes/sneakers/sneakers-details.dart';
...
import 'flat-details.dart';


class SingleBallerinas extends StatefulWidget {
  SingleBallerinas({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<SingleBallerinas> createState() => _SingleBallerinasState();
}

class _SingleBallerinasState extends State<SingleBallerinas> {
    ...
    return GestureDetector(
      ...
      onTap: () async {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => BallerinasDetails(
