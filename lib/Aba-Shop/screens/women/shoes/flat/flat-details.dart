...
class BallerinasDetails extends StatefulWidget {
  BallerinasDetails({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<BallerinasDetails> createState() => _BallerinasDetailsState();
}

class _BallerinasDetailsState extends State<BallerinasDetails> {
