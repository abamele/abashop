...
import '../../../../providers/women-provider/hijab-provider/dress-provider.dart';
...
class _DressPageState extends State<DressPage> {
  ...
  Widget build(BuildContext context) {
    DressProvider dressProvider = Provider.of(context);
    dressProvider.getDressData();
    ...
    return Scaffold(
      ...
      drawer: NavberWidget(),
      body: dressProvider.dressDataList.isEmpty
          ? Center(
        child: Text("No Data"),
      )
          : GridView.builder(
          gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
              ...
              crossAxisSpacing: 5,
              mainAxisSpacing: 5),
          itemCount: dressProvider.getDressDataList.length,
          itemBuilder: (context, index) {
            final data = dressProvider.getDressDataList[index];
            return SingleDress(productModel: data);
          }),
    );
  }
}
