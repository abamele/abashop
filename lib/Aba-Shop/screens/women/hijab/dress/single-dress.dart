...
import 'dress-details.dart';


class SingleDress extends StatefulWidget {
  SingleDress({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<SingleDress> createState() => _SingleDressState();
}

class _SingleDressState extends State<SingleDress> {
