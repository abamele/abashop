...
class TunicDetails extends StatefulWidget {
  TunicDetails({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<TunicDetails> createState() => _TunicDetailsState();
}

class _TunicDetailsState extends State<TunicDetails> {
