...
import 'package:abashop/Aba-Shop/screens/women/hijab/tunic/tunic-details.dart';
...
class SingleTunic extends StatefulWidget {
  SingleTunic({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<SingleTunic> createState() => _SingleTunicState();
}

class _SingleTunicState extends State<SingleTunic> {
