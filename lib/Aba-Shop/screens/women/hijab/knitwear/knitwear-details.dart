...
class PantDetails extends StatefulWidget {
  PantDetails({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<PantDetails> createState() => _PantDetailsState();
}

class _PantDetailsState extends State<PantDetails> {
