...
class SingleKnitwear extends StatefulWidget {
  SingleKnitwear({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<SingleKnitwear> createState() => _SingleKnitwearState();
}

class _SingleKnitwearState extends State<SingleKnitwear> {
