import 'package:abashop/Aba-Shop/screens/women/hijab/suit/single-suit.dart';
...
import '../../../../providers/women-provider/hijab-provider/suit-provider.dart';
...
class _SuitPageState extends State<SuitPage> {
  ...
  Widget build(BuildContext context) {
    SuitProvider suitProvider = Provider.of(context);
    suitProvider.getSuitData();
    ...
    return Scaffold(
      ...
      drawer: NavberWidget(),
      body: suitProvider.suitDataList.isEmpty
          ? Center(
        child: Text("No Data"),
      )
          : GridView.builder(
          gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
              ...
              crossAxisSpacing: 5,
              mainAxisSpacing: 5),
          itemCount: suitProvider.getSuitDataList.length,
          itemBuilder: (context, index) {
            final data = suitProvider.getSuitDataList[index];
            return SingleSuit(productModel: data);
          }),
    );
  }
}
