...
class SuitDetails extends StatefulWidget {
  SuitDetails({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<SuitDetails> createState() => _SuitDetailsState();
}

class _SuitDetailsState extends State<SuitDetails> {
