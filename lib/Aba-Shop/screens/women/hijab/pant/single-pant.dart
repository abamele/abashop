...
class SinglePant extends StatefulWidget {
  SinglePant({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<SinglePant> createState() => _SinglePantState();
}

class _SinglePantState extends State<SinglePant> {
