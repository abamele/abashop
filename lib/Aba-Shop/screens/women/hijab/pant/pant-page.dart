...
class _PantPageState extends State<PantPage> {
  ...
  Widget build(BuildContext context) {
    PantsProvider pantsProvider = Provider.of(context);
    pantsProvider.getPantsData();
    ...
    return Scaffold(
      ...
      drawer: NavberWidget(),
      body: pantsProvider.pantDataList.isEmpty
          ? Center(
        child: Text("No Data"),
      )
          : GridView.builder(
          gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
              ...
              crossAxisSpacing: 5,
              mainAxisSpacing: 5),
          itemCount: pantsProvider.getPantsDataList.length,
          itemBuilder: (context, index) {
            final data = pantsProvider.getPantsDataList[index];
            return SinglePant(productModel: data);
          }),
    );
  }
}
