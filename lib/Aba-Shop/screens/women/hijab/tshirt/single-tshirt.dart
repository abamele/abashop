...
import 'package:abashop/Aba-Shop/screens/women/hijab/tshirt/tshirt-details.dart';
...
class SingleWomenTShirt extends StatefulWidget {
  SingleWomenTShirt({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<SingleWomenTShirt> createState() => _SingleWomenTShirtState();
}

class _SingleWomenTShirtState extends State<SingleWomenTShirt> {
    ...
    return GestureDetector(
      ...
      onTap: () async {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => WomenTShirtDetails(
