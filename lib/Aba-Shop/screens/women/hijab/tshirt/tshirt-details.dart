...
class WomenTShirtDetails extends StatefulWidget {
  WomenTShirtDetails({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<WomenTShirtDetails> createState() => _WomenTShirtDetailsState();
}

class _WomenTShirtDetailsState extends State<WomenTShirtDetails> {
