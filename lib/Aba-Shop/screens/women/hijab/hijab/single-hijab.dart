...
import 'hijab-details.dart';


class SingleHijab extends StatefulWidget {
  SingleHijab({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<SingleHijab> createState() => _SingleHijabState();
}

class _SingleHijabState extends State<SingleHijab> {
