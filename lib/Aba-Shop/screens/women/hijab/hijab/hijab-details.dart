...
class HijabDetails extends StatefulWidget {
  HijabDetails({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<HijabDetails> createState() => _HijabDetailsState();
}

class _HijabDetailsState extends State<HijabDetails> {
