...
import 'package:abashop/Aba-Shop/screens/women/hijab/hijab-tracksuit/hijab-tracksuit-details.dart';
import 'package:abashop/Aba-Shop/screens/women/hijab/pant/pant-details.dart';
...
class SingleHijabTracksuit extends StatefulWidget {
  SingleHijabTracksuit({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<SingleHijabTracksuit> createState() => _SingleHijabTracksuitState();
}

class _SingleHijabTracksuitState extends State<SingleHijabTracksuit> {
    ...
    return GestureDetector(
      ...
      onTap: () async {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => HijabTracksuitDetails(
