...
class HijabTracksuitDetails extends StatefulWidget {
  HijabTracksuitDetails({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<HijabTracksuitDetails> createState() => _HijabTracksuitDetailsState();
}

class _HijabTracksuitDetailsState extends State<HijabTracksuitDetails> {
