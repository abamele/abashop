...
class SingleWaistcoat extends StatefulWidget {
  SingleWaistcoat({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<SingleWaistcoat> createState() => _SingleWaistcoatState();
}

class _SingleWaistcoatState extends State<SingleWaistcoat> {
