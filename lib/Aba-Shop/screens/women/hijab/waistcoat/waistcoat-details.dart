...
class WastcoatDetails extends StatefulWidget {
  WastcoatDetails({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<WastcoatDetails> createState() => _WastcoatDetailsState();
}

class _WastcoatDetailsState extends State<WastcoatDetails> {
