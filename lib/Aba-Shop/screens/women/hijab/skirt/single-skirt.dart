...
import 'package:abashop/Aba-Shop/screens/women/hijab/skirt/skirt-details.dart';
...
class SingleSkirt extends StatefulWidget {
  SingleSkirt({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<SingleSkirt> createState() => _SingleSkirtState();
}

class _SingleSkirtState extends State<SingleSkirt> {
