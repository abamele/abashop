import 'package:abashop/Aba-Shop/screens/women/hijab/skirt/single-skirt.dart';
...
import '../../../../providers/women-provider/hijab-provider/skirt-provider.dart';
...
class _SkirtPageState extends State<SkirtPage> {
  ...
  Widget build(BuildContext context) {
    SkirtProvider skirtProvider = Provider.of(context);
    skirtProvider.getSkirtData();
    ...
    return Scaffold(
      ...
      drawer: NavberWidget(),
      body: skirtProvider.skirtDataList.isEmpty
          ? Center(
        child: Text("No Data"),
      )
          : GridView.builder(
          gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
              ...
              crossAxisSpacing: 5,
              mainAxisSpacing: 5),
          itemCount: skirtProvider.getSkirtDataList.length,
          itemBuilder: (context, index) {
            final data = skirtProvider.getSkirtDataList[index];
            return SingleSkirt(productModel: data);
          }),
    );
  }
}
