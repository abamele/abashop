...
import 'new-season-details.dart';

class SingleNewSeason extends StatefulWidget {
  SingleNewSeason({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<SingleNewSeason> createState() => _SingleNewSeasonState();
}

class _SingleNewSeasonState extends State<SingleNewSeason> {
            ...
            children: [
                          ...
                          child: IconButton(
                            ...
                            onPressed: () {
                              setState(() {
                                ...
                                wishListProvider.updateWishList(wishListBool,
                                    widget.productModel.productId, context);
                              });
                            },
                          ),
                        ),
              ...
              Padding(
                ...
                child: Text(
                  ...
                  maxLines:
                      1, // Kaç satır görüneceğini buradan ayarlayabilirsiniz
