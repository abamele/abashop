...
class NewSeasonDetails extends StatefulWidget {
  NewSeasonDetails({super.key, required this.productModel});
  ProductModel productModel;
  @override
  State<NewSeasonDetails> createState() => _NewSeasonDetailsState();
}

class _NewSeasonDetailsState extends State<NewSeasonDetails> {
